...
import Cubes
print('Welcome to Cubes_nonoise_simple! \n \nAvailable functions: \n  image_make: Produces a 2D map and 1D plot of the noise-corrected structure function.')

def image_make(vmin, vmax, ymin, ymax, xmin, xmax, deltaX = 100, deltaV = 3, deltadeltaX = 10):
	"""Generates a noise-corrected 2D map and 1D plot of S_2, from subcube of the 
	   ...
	   ^ These are the parameters of the desired subcube, along with maximum dX/dY,
	     maximum dZ, and "step size" for calculating S_2.
	...
	Cubes.mapgen(S_2, deltaX, deltaV)
	Cubes.plotgen(S_2, deltaX, deltaV, deltadeltaX)
